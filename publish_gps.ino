 ...
 * Description: ESP32 publishes GPS position to AskSensors using MQTT
...
void setup() {
  Serial.begin(115200);
  Serial.println("*****************************************************");
  Serial.println("********** Program Start : ESP32 publishes GPS position to AskSensors over MQTT");
...
void loop() {
  ...
  snprintf (mqtt_payload, 50, "m1=%f;%f", latitude, longitude);
